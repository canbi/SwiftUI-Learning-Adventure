...
struct ProspectsView: View {
    ...
    var title: String {
        switch filter {
        case .none:
            return "Everyone"case .contacted:
            return "Contacted people"case .uncontacted:
            ...
            List {
                ForEach(filteredProspects) { prospect in
                    ...
                    .confirmationDialog("Sort Settings", isPresented: $isShowingSorting) {
                        Button("Most recent") {prospects.sortDate(isAsc: false)}
                        Button("Sorted by Name") {prospects.sortName(isAsc: true)}
                        Button("Sorted by Email") {prospects.sortEmail(isAsc: true)}
