...
class Habits: ObservableObject{
    ...
    @Published var trackingTypes = ["Time Tracking", "Number of Times"]
    
    @Published var routineTypes = ["Daily", "Every Two Days", "Every Three Days", "Weekly", "Every Two Week", "Every Month", "Yearly"]
    
    @Published var minuteTypes: [TrackingType] = [TrackingType("1 Minute",Color("ColorSet1")),
    ...
    @Published var numberOfTimeTypes: [TrackingType] = [TrackingType("1 Time",Color("ColorSet1")),
